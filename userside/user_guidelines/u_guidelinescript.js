$(function(){
    ...
    $("#btn_back").click(function(){
        window.location.href = "/tourism_information_system/userside/user_guidelines/u_guidelines.php";
        
    });

    $(document.body).on("click",".btn_bookmark",function() {
       
		Bookmark(parseInt($(this).attr("guidelines_id")));

	});

});

function Bookmark(guidelines_id){
    var c_id = "";

    c_id = "guidelines_id=" + guidelines_id;
    ...
    $.ajax({
        ...
        "success": function(text){
            if(text == "not login"){
                ...
                $("[guidelines_id="+guidelines_id+"]").prop("src", bookmark.url);
            }
