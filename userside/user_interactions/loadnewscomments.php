<?php 
    ...
    $query = "select * from tbl_newscomments where news_id=".intval($_REQUEST["news_id"]);
        ...
        $comments .= "<div class='i_comments'>
                        <table>
                            <tr>
                                ...
                                $resultwriterid = $conn->query("select * from tbl_news where id='".intval($_REQUEST["news_id"])."'");
                                ...
                                <td align='left'><span id='news_writer_name'>$writer_name</span>
                                <span id='news_writer_username'>@$writer_username</span><br>
                                <span id='news_datetime'>$date_time</span><br><br>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                    ...
                                    if(!empty($img_comments)){
                                        ...
                                        foreach($img_comments as $values){
                                            ...
                                            if(strtoupper($typefile[1]) == "MP4"){
                                                ...
                                                $comments .= "<br><div class='col-sm'>
                                                <img src='$imageURL" . "$values' alt='Image' class='newsimages'>
                                                </div>
                                                ";
                                            }
