...
<head>
    ...
    <link rel="stylesheet" href="u_storestyle.css">
    <title>Stores</title>
</head>
<body>
    <!--header-->
    ...
    <div class="container fluid">
        <div class="contentdiv">
            ...
            <div class="row" id="title_div">
                <div class="col-sm-6">
                    <h1 id="page-title"><a href="u_stores.php">Stores</a></h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="stores_menudiv">
                <table id="tbl_d_menu">
                    <tr>
                        ...
                        <td><a href="/tourism_information_system/userside/user_stores/u_stores.php" style="color: #00bd1c; ">Stores</a></td>
                    </tr>
                </table>
            </div>
            

            <div class="result_storesdiv" style='<?php 
            ...
            ?>'>
                <div class="row">
                    <?php 
                        ...
                        if(isset($_GET["municipality"])){
                            $result = $conn->query("select * from tbl_stores where admin_id = '$_GET[municipality]' order by id DESC");
                        }else{
                            $result = $conn->query("select * from tbl_stores order by id DESC");
                        }
                        ...
                        for ($i = 0; $i < $numColumns; $i++) {
                            ...
                            foreach ($columnData[$i] as $row) {
                                ...
                                echo "<div class='stores_container'>
                                    <div class='shortcutsdiv' >";
                                    
                                    echo "<img src='/tourism_information_system/adminside/stores/uploaded_images/{$row['fld_mainimage']}' alt='Image' class='mainImage'>
                                        <div class='centeredtxt'>
                                            <h4 class='stores_title'>{$row['fld_name']}</h4>
...
<script src="u_storescript.js"></script>
</html>